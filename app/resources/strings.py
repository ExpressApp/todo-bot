...
INPUT_TASK_TEXT_TEXT = "Введите текст задачи:"
INPUT_TASK_TITLE_TEXT = "Введите название задачи:"
TASK_CREATED_TEMPLATE = lookup.get_template("approve_task.txt.mako")
TASK_CREATED_TEXT = "Задача успешно создана!"

TASK_DELETED_TEMPLATE = lookup.get_template("task_deleted.txt.mako")

PREV_TASK_LABEL = "<- Назад"
NEXT_TASK_LABEL = "Вперед ->"
EXPAND_TASK_LABEL = "Раскрыть задачу полностью"

YOU_HAVE_NO_TASKS_TEXT = "У вас нет задач"

DELETE_TASK_LABEL = "Удалить задачу"
HIDE_TASK_LABEL = "Свернуть задачу"
